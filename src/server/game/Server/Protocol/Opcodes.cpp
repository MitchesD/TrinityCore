...
#define DEFINE_OPCODE_HANDLER_OLD(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_DF_JOIN,                                            STATUS_LOGGEDIN,  PROCESS_INPLACE,      WorldPackets::LFG::DfJoin, &WorldSession::HandleDfJoinOpcode);
    ...
    DEFINE_HANDLER(CMSG_DF_SET_COMMENT,                                     STATUS_LOGGEDIN,  PROCESS_INPLACE,      WorldPackets::LFG::DfSetComment, &WorldSession::HandleLfgSetCommentOpcode);
    ...
    DEFINE_HANDLER(CMSG_LFG_LIST_GET_STATUS,                                STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   WorldPackets::LFG::LFGListGetStatus, &WorldSession::HandleLfgListGetStatus);
